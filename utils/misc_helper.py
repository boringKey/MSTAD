...
def save_reverse_checkpoint(state, is_best, config):

    folder = config.save_path

    torch.save(state, os.path.join(folder, "reverse.pth.tar"))
    if is_best:
        shutil.copyfile(
            os.path.join(folder, "reverse.pth.tar"),
            os.path.join(folder, "reverse_best.pth.tar"),
        )
    ...
    if config.saver.get(
        ...
        shutil.copyfile(
            os.path.join(folder, "reverse.pth.tar"),
            os.path.join(folder, f"reverse_{epoch}.pth.tar"),
        )
